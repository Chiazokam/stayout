/**
 * @description - Base Email Template
                    ...
                    <tbody>
                      <tr>
                        <td valign="top" align="center">
                          <p style="font-family: 'Segoe UI','Roboto','Oxygen','Ubuntu','Cantarell','Fira Sans','Droid Sans','Helvetica Neue',sans-serif;color:#371E1A;line-height:20px;font-size:3rem;">STAYOUT</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                            ...
                            <tbody>
                              <tr>
                                <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                  <img alt="Authors Haven Image" width="80" src="https://res.cloudinary.com/zokky/image/upload/v1562757907/envelope_PNG18398.png" />
                                </td>
                              </tr>
                              <tr>
                                <td height="30" &nbsp;=""></td>
                              ...
                              <tr>
                                <td valign="top" width="48%" align="center"> <span>
                                    <a href=${process.env.FRONTEND_URL} style="display:block; padding:15px 25px; background-color:#371E1A; color:#F5F6FA; text-decoration:none;">Visit Stayout</a>
                                  </span>
                                </td>
                              </tr>
                            </tbody>
